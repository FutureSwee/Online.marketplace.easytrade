...
// Add this function to check for unread messages
...
// If user is logged in, get unread message count
$unread_count = 0;
if (isset($_SESSION['userArray'])) {
    $unread_count = getUnreadMessageCount($conn, $_SESSION['userArray']['id']);
}
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li class="messages-item">
                                    <a class="dropdown-item" href="views/messages.php">
                                        <i class="bi bi-chat-dots me-2"></i>Messages
                                        <?php if ($unread_count > 0): ?>
                                            <span
                                                class="messages-badge"><?php echo $unread_count > 99 ? '99+' : $unread_count; ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                                <li>
    ...
    <div class="modal fade" id="roleModal" tabindex="-1" aria-labelledby="roleModalLabel" aria-hidden="true">
      ...
      <script>
        ...
        function updateNotificationCount() {
                fetch('controllers/get_notification_count.php')
                    .then(response => response.json())
                    .then(data => {
                        ...
                        if (data.count > 0) {
                            ...
                            if (messagesBadge) {
                                messagesBadge.textContent = displayCount;
                            }
                        } else {
                            if (badge) {
