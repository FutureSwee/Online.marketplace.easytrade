...
//marketplacetut.onlinewebshop.net/includes/database/connection.php
...
<style>
    ...
    .user-icon:hover {
        ...
        background: linear-gradient(135deg, #2a75ea, #732bdb);
    }
    ...
    /* Header styling for user icon placement */
    .dashboard-header {
        display: flex;
        ...
        <?php if (isset($_SESSION['userArray'])): ?>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    <li>
                        <a class="dropdown-item" href="views/update_user.php">
                            <i class="bi bi-person-gear"></i>Update Profile
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#roleModal">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-7">
                                                <div class="d-flex w-100 justify-content-between">
                                                    ...
                                                    <span class="price-tag">R<?php echo $listing['price']; ?></span>
                                                </div>
                                                <p class="mb-1">
